const listaProdutos = [
    {id:1, nome:"Blush", preco: 199, imagem:"img/Produto1.jpg"},
    {id:2, nome:"Halo Glow", preco: 145, imagem:"img/Produto2.jpg"},
    {id:3, nome:"Gloss Shine", preco: 89, imagem:"img/Produto3.jpg"},
    {id:1, nome:"Pink Iluminador", preco: 120, imagem:"img/Produto4.jpg"}
]
...
barraPesquisa.addEventListener("input", () => {
    ...
    const produtosFiltrados = listaProdutos.filter(produto =>
        produto.nome.toLocaleLowerCase().includes(textoPesquisa)
    )
